    ...
    if (this.state.initialized) {
      return (
        <div id="overview">
          ...
          <Styles productById={this.state.productById} productStylesById={this.state.productStylesById} currentStyleHandler = {this.props.currentStyleHandler} yourOutfitHandleClick = {this.props.yourOutfitHandleClick}/>
